...
export default {
    ...
    methods: {
        ...
        zoomIn() {
            const originTranformStr = this.$refs.domContainer.style.transform

            let targetScale = 1 * 1.2
            const scaleMatchResult = originTranformStr.match(MATCH_SCALE_REGEX)
        ...
        isVertical() {
            return this.direction === DIRECTION.VERTICL
        },
        ...
        initTranform() {
            ...
            generateLinkPath(d) {
                ...
                linkPath
                    ...
                    .source(function (d) {
                        ...
                        return self.direction === self.DIRECTION.VERTICL
                        ? sourcePoint
                ...
                if(this.LinkStyle === LinkStyle.STRAIGHT) {
                    //this link path is source -> secondPoint -> thirdPoint -> target
            ...
            draw() {
                ...
                const self = this
                const links = this.vg.selectAll('.link').data(linkDataList, (d) => {
